  ...
  useEffect( () => {
    const pageData = async (id) => {
      ...
      const response = await fetch(
        process.env.GATSBY_DRUPAL_HOST + `/jsonapi/node?filter[drupal_internal__nid]=` + id,
        requestHeaders
      )
