  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        height: `100%`,
        width: `100%`,
        background: (theme) => `linear-gradient(45deg, ${data.background_color ? rgba(data.background_color, .72) : "transparent"}, ${data.background_color ? rgba(darken(data.background_color, .2)(theme), .72) : "transparent"})`
      }}>
        <Box sx={{
          maxWidth: `1200px`,
          m: `0 auto`,
...
export const sliderBlock = {
  ...
  fields: [
    ...
    },
    {
      ...
      component: "color",
      widget: "block",
      colors: [`${cssVar("--theme-ui-colors-text", "#000")}`, `${cssVar("--theme-ui-colors-background", "#000")}`, `${cssVar("--theme-ui-colors-primary", "#000")}`, `${cssVar("--theme-ui-colors-secondary", "#000")}`, `${cssVar("--theme-ui-colors-muted", "#000")}`, `${cssVar("--theme-ui-colors-white", "#000")}`]
    },
    {
      name: "align",
      label: "Alignment",
